* [Frequently Asked Questions](FAQ.md#frequently-asked-questions)
  * [General](FAQ.md#general)
    * [Q: What is Open vSwitch?](FAQ.md#q-what-is-open-vswitch)
    * [Q: What virtualization platforms can use Open vSwitch?](FAQ.md#q-what-virtualization-platforms-can-use-open-vswitch)
    * [Q: How can I try Open vSwitch?](FAQ.md#q-how-can-i-try-open-vswitch)
    * [Q: Does Open vSwitch only work on Linux?](FAQ.md#q-does-open-vswitch-only-work-on-linux)
    * [Q: What's involved with porting Open vSwitch to a new platform or switching ASIC?](FAQ.md#q-whats-involved-with-porting-open-vswitch-to-a-new-platform-or-switching-asic)
    * [Q: Why would I use Open vSwitch instead of the Linux bridge?](FAQ.md#q-why-would-i-use-open-vswitch-instead-of-the-linux-bridge)
    * [Q: How is Open vSwitch related to distributed virtual switches like the VMware vNetwork distributed switch or the Cisco Nexus 1000V?](FAQ.md#q-how-is-open-vswitch-related-to-distributed-virtual-switches-like-the-vmware-vnetwork-distributed-switch-or-the-cisco-nexus-1000v)
    * [Q: Why doesn't Open vSwitch support distribution?](FAQ.md#q-why-doesnt-open-vswitch-support-distribution)
    * [Q: How can I contribute to the Open vSwitch Community?](FAQ.md#q-how-can-i-contribute-to-the-open-vswitch-community)
    * [Q: Why can I no longer connect to my OpenFlow controller or OVSDB manager?](FAQ.md#q-why-can-i-no-longer-connect-to-my-openflow-controller-or-ovsdb-manager)
  * [Releases](FAQ.md#releases)
    * [Q: What does it mean for an Open vSwitch release to be LTS (long\-term support)?](FAQ.md#q-what-does-it-mean-for-an-open-vswitch-release-to-be-lts-long-term-support)
    * [Q: What Linux kernel versions does each Open vSwitch release work with?](FAQ.md#q-what-linux-kernel-versions-does-each-open-vswitch-release-work-with)
    * [Q: Are all features available with all datapaths?](FAQ.md#q-are-all-features-available-with-all-datapaths)
    * [Q: What DPDK version does each Open vSwitch release work with?](FAQ.md#q-what-dpdk-version-does-each-open-vswitch-release-work-with)
    * [Q: I get an error like this when I configure Open vSwitch:](FAQ.md#q-i-get-an-error-like-this-when-i-configure-open-vswitch)
    * [Q: What features are not available in the Open vSwitch kernel datapath that ships as part of the upstream Linux kernel?](FAQ.md#q-what-features-are-not-available-in-the-open-vswitch-kernel-datapath-that-ships-as-part-of-the-upstream-linux-kernel)
    * [Q: Why do tunnels not work when using a kernel module other than the one packaged with Open vSwitch?](FAQ.md#q-why-do-tunnels-not-work-when-using-a-kernel-module-other-than-the-one-packaged-with-open-vswitch)
    * [Q: Why are UDP tunnel checksums not computed for VXLAN or Geneve?](FAQ.md#q-why-are-udp-tunnel-checksums-not-computed-for-vxlan-or-geneve)
    * [Q: What features are not available when using the userspace datapath?](FAQ.md#q-what-features-are-not-available-when-using-the-userspace-datapath)
    * [Q: Should userspace or kernel be upgraded first to minimize downtime?](FAQ.md#q-should-userspace-or-kernel-be-upgraded-first-to-minimize-downtime)
    * [Q: What happened to the bridge compatibility feature?](FAQ.md#q-what-happened-to-the-bridge-compatibility-feature)
  * [Terminology](FAQ.md#terminology)
    * [Q: I thought Open vSwitch was a virtual Ethernet switch, but the documentation keeps talking about bridges\.  What's a bridge?](FAQ.md#q-i-thought-open-vswitch-was-a-virtual-ethernet-switch-but-the-documentation-keeps-talking-about-bridges--whats-a-bridge)
    * [Q: What's a VLAN?](FAQ.md#q-whats-a-vlan)
  * [Basic Configuration](FAQ.md#basic-configuration)
    * [Q: How do I configure a port as an access port?](FAQ.md#q-how-do-i-configure-a-port-as-an-access-port)
    * [Q: How do I configure a port as a SPAN port, that is, enable mirroring of all traffic to that port?](FAQ.md#q-how-do-i-configure-a-port-as-a-span-port-that-is-enable-mirroring-of-all-traffic-to-that-port)
    * [Q: Does Open vSwitch support configuring a port in promiscuous mode?](FAQ.md#q-does-open-vswitch-support-configuring-a-port-in-promiscuous-mode)
    * [Q: How do I configure a DPDK port as an access port?](FAQ.md#q-how-do-i-configure-a-dpdk-port-as-an-access-port)
    * [Q: How do I configure a VLAN as an RSPAN VLAN, that is, enable mirroring of all traffic to that VLAN?](FAQ.md#q-how-do-i-configure-a-vlan-as-an-rspan-vlan-that-is-enable-mirroring-of-all-traffic-to-that-vlan)
    * [Q: Can I mirror more than one input VLAN to an RSPAN VLAN?](FAQ.md#q-can-i-mirror-more-than-one-input-vlan-to-an-rspan-vlan)
    * [Q: How do I configure mirroring of all traffic to a GRE tunnel?](FAQ.md#q-how-do-i-configure-mirroring-of-all-traffic-to-a-gre-tunnel)
    * [Q: Does Open vSwitch support ERSPAN?](FAQ.md#q-does-open-vswitch-support-erspan)
    * [Q: How do I connect two bridges?](FAQ.md#q-how-do-i-connect-two-bridges)
    * [Q: How do I configure a bridge without an OpenFlow local port?  (Local port in the sense of OFPP\_LOCAL)](FAQ.md#q-how-do-i-configure-a-bridge-without-an-openflow-local-port--local-port-in-the-sense-of-ofpp_local)
  * [Implementation Details](FAQ.md#implementation-details)
    * [Q: I hear OVS has a couple of kinds of flows\.  Can you tell me about them?](FAQ.md#q-i-hear-ovs-has-a-couple-of-kinds-of-flows--can-you-tell-me-about-them)
    * [Q: Why are there so many different ways to dump flows?](FAQ.md#q-why-are-there-so-many-different-ways-to-dump-flows)
    * [Q: How does multicast snooping works with VLANs?](FAQ.md#q-how-does-multicast-snooping-works-with-vlans)
    * [Q: Can OVS populate the kernel flow table in advance instead of in reaction to packets?](FAQ.md#q-can-ovs-populate-the-kernel-flow-table-in-advance-instead-of-in-reaction-to-packets)
  * [Performance](FAQ.md#performance)
    * [Q: I just upgraded and I see a performance drop\.  Why?](FAQ.md#q-i-just-upgraded-and-i-see-a-performance-drop--why)
  * [Configuration Problems](FAQ.md#configuration-problems)
    * [Q: I created a bridge and added my Ethernet port to it, using commands](FAQ.md#q-i-created-a-bridge-and-added-my-ethernet-port-to-it-using-commands)
    * [Q: I created a bridge and added a couple of Ethernet ports to it,](FAQ.md#q-i-created-a-bridge-and-added-a-couple-of-ethernet-ports-to-it)
    * [using commands like these:](FAQ.md#using-commands-like-these)
    * [Q: I can't seem to use Open vSwitch in a wireless network\.](FAQ.md#q-i-cant-seem-to-use-open-vswitch-in-a-wireless-network)
    * [Q: I can't seem to add my PPP interface to an Open vSwitch bridge\.](FAQ.md#q-i-cant-seem-to-add-my-ppp-interface-to-an-open-vswitch-bridge)
    * [Q: Is there any documentation on the database tables and fields?](FAQ.md#q-is-there-any-documentation-on-the-database-tables-and-fields)
    * [Q: When I run ovs\-dpctl I no longer see the bridges I created\.  Instead,](FAQ.md#q-when-i-run-ovs-dpctl-i-no-longer-see-the-bridges-i-created--instead)
    * [Q: I created a GRE port using ovs\-vsctl so why can't I send traffic or](FAQ.md#q-i-created-a-gre-port-using-ovs-vsctl-so-why-cant-i-send-traffic-or)
    * [Q: Open vSwitch does not seem to obey my packet filter rules\.](FAQ.md#q-open-vswitch-does-not-seem-to-obey-my-packet-filter-rules)
    * [Q: It seems that Open vSwitch does nothing when I removed a port and](FAQ.md#q-it-seems-that-open-vswitch-does-nothing-when-i-removed-a-port-and)
    * [Q: I want to add thousands of ports to an Open vSwitch bridge, but](FAQ.md#q-i-want-to-add-thousands-of-ports-to-an-open-vswitch-bridge-but)
    * [Q: I created a bridge named br0\.  My bridge shows up in "ovs\-vsctl](FAQ.md#q-i-created-a-bridge-named-br0--my-bridge-shows-up-in-ovs-vsctl)
    * [Q: I have a bridge br0\.  I added a new port vif1\.0, and it shows](FAQ.md#q-i-have-a-bridge-br0--i-added-a-new-port-vif10-and-it-shows)
    * [Q: I created a tap device tap0, configured an IP address on it, and](FAQ.md#q-i-created-a-tap-device-tap0-configured-an-ip-address-on-it-and)
  * [Quality of Service (QoS)](FAQ.md#quality-of-service-qos)
    * [Q: Does OVS support Quality of Service (QoS)?](FAQ.md#q-does-ovs-support-quality-of-service-qos)
    * [Q: How do I configure egress traffic shaping?](FAQ.md#q-how-do-i-configure-egress-traffic-shaping)
    * [Q: How do I configure ingress policing?](FAQ.md#q-how-do-i-configure-ingress-policing)
    * [Q: I configured Quality of Service (QoS) in my OpenFlow network by](FAQ.md#q-i-configured-quality-of-service-qos-in-my-openflow-network-by)
    * [Q: I'd like to take advantage of some QoS feature that Open vSwitch](FAQ.md#q-id-like-to-take-advantage-of-some-qos-feature-that-open-vswitch)
    * [Q: I configured QoS, correctly, but my measurements show that it isn't](FAQ.md#q-i-configured-qos-correctly-but-my-measurements-show-that-it-isnt)
    * [Q: Does Open vSwitch support OpenFlow meters?](FAQ.md#q-does-open-vswitch-support-openflow-meters)
  * [VLANs](FAQ.md#vlans)
    * [Q: What's a VLAN?](FAQ.md#q-whats-a-vlan-1)
    * [Q: VLANs don't work\.](FAQ.md#q-vlans-dont-work)
    * [Q: VLANs still don't work\.  I've tested the driver so I know that it's OK\.](FAQ.md#q-vlans-still-dont-work--ive-tested-the-driver-so-i-know-that-its-ok)
    * [Q: Outgoing VLAN\-tagged traffic goes through OVS to my physical switch](FAQ.md#q-outgoing-vlan-tagged-traffic-goes-through-ovs-to-my-physical-switch)
    * [Q: I added a pair of VMs on different VLANs, like this:](FAQ.md#q-i-added-a-pair-of-vms-on-different-vlans-like-this)
    * [Q: I added a pair of VMs on the same VLAN, like this:](FAQ.md#q-i-added-a-pair-of-vms-on-the-same-vlan-like-this)
    * [Q: Can I configure an IP address on a VLAN?](FAQ.md#q-can-i-configure-an-ip-address-on-a-vlan)
    * [Q: I configured one IP address on VLAN 0 and another on VLAN 9, like](FAQ.md#q-i-configured-one-ip-address-on-vlan-0-and-another-on-vlan-9-like)
    * [Q: My OpenFlow controller doesn't see the VLANs that I expect\.](FAQ.md#q-my-openflow-controller-doesnt-see-the-vlans-that-i-expect)
    * [Q: I configured ports on a bridge as access ports with different VLAN](FAQ.md#q-i-configured-ports-on-a-bridge-as-access-ports-with-different-vlan)
    * [Q: How MAC learning works with VLANs?](FAQ.md#q-how-mac-learning-works-with-vlans)
  * [VXLANs](FAQ.md#vxlans)
    * [Q: What's a VXLAN?](FAQ.md#q-whats-a-vxlan)
    * [Q: How much of the VXLAN protocol does Open vSwitch currently support?](FAQ.md#q-how-much-of-the-vxlan-protocol-does-open-vswitch-currently-support)
    * [Q: What destination UDP port does the VXLAN implementation in Open vSwitch](FAQ.md#q-what-destination-udp-port-does-the-vxlan-implementation-in-open-vswitch)
  * [Using OpenFlow (Manually or Via Controller)](FAQ.md#using-openflow-manually-or-via-controller)
    * [Q: What versions of OpenFlow does Open vSwitch support?](FAQ.md#q-what-versions-of-openflow-does-open-vswitch-support)
    * [Q: Does Open vSwitch support MPLS?](FAQ.md#q-does-open-vswitch-support-mpls)
    * [Q: I'm getting "error type 45250 code 0"\.  What's that?](FAQ.md#q-im-getting-error-type-45250-code-0--whats-that)
    * [Q: I configured all my controllers for out\-of\-band control mode but](FAQ.md#q-i-configured-all-my-controllers-for-out-of-band-control-mode-but)
    * [Q: My OpenFlow controller doesn't see the VLANs that I expect\.](FAQ.md#q-my-openflow-controller-doesnt-see-the-vlans-that-i-expect-1)
    * [Q: I ran "ovs\-ofctl add\-flow br0 nw\_dst=192\.168\.0\.1,actions=drop"](FAQ.md#q-i-ran-ovs-ofctl-add-flow-br0-nw_dst19216801actionsdrop)
    * [Q: How can I figure out the OpenFlow port number for a given port?](FAQ.md#q-how-can-i-figure-out-the-openflow-port-number-for-a-given-port)
    * [Q: I added some flows with my controller or with ovs\-ofctl, but when I](FAQ.md#q-i-added-some-flows-with-my-controller-or-with-ovs-ofctl-but-when-i)
    * [Q: It looks like each of the interfaces in my bonded port shows up](FAQ.md#q-it-looks-like-each-of-the-interfaces-in-my-bonded-port-shows-up)
    * [Q: I have a sophisticated network setup involving Open vSwitch, VMs or](FAQ.md#q-i-have-a-sophisticated-network-setup-involving-open-vswitch-vms-or)
    * [Q: How do I make a flow drop packets?](FAQ.md#q-how-do-i-make-a-flow-drop-packets)
    * [Q: I added a flow to send packets out the ingress port, like this:](FAQ.md#q-i-added-a-flow-to-send-packets-out-the-ingress-port-like-this)
    * [Q: My bridge br0 has host 192\.168\.0\.1 on port 1 and host 192\.168\.0\.2](FAQ.md#q-my-bridge-br0-has-host-19216801-on-port-1-and-host-19216802)
    * [Q: My bridge disconnects from my controller on add\-port/del\-port\.](FAQ.md#q-my-bridge-disconnects-from-my-controller-on-add-portdel-port)
    * [Q: My controller is getting errors about "buffers"\.  What's going on?](FAQ.md#q-my-controller-is-getting-errors-about-buffers--whats-going-on)
    * [Q: How does OVS divide flows among buckets in an OpenFlow "select" group?](FAQ.md#q-how-does-ovs-divide-flows-among-buckets-in-an-openflow-select-group)
    * [Q: I added a flow to accept packets on VLAN 123 and output them on](FAQ.md#q-i-added-a-flow-to-accept-packets-on-vlan-123-and-output-them-on)
  * [Development](FAQ.md#development)
    * [Q: How do I implement a new OpenFlow message?](FAQ.md#q-how-do-i-implement-a-new-openflow-message)
    * [Q: How do I add support for a new field or header?](FAQ.md#q-how-do-i-add-support-for-a-new-field-or-header)
    * [Q: How do I add support for a new OpenFlow action?](FAQ.md#q-how-do-i-add-support-for-a-new-openflow-action)
  * [Contact](FAQ.md#contact)
